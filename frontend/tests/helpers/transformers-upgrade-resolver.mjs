...
const STUB = new URL("./transformers-upgrade-stub.mjs", import.meta.url).href;
...
export function resolve(specifier, context, next) {
  if (
    specifier === "@/features/transformers-upgrade" ||
    /(^|\/)features\/transformers-upgrade$/.test(specifier)
  ) {
