...
export const it = {
  ...
  settings: {
    ...
    dialog: {
      title: "Impostazioni",
      description: "Gestisci le tue preferenze di FlickerX.",
    ...
    debugging: {
      ...
      disabled: "La registrazione su file è disattivata (FLICKERX_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Caricato",
        sttUnavailable:
          "Non installato su questo server. Esegui `flickerx studio update` per abilitare la dettatura locale.",
        sttRetry: "Riprova",
        ...
        micAccessBlocked:
          "L'accesso al microfono è stato bloccato. Consenti l'accesso al microfono per questa pagina di FlickerX, poi riprova.",
    ...
    general: {
      title: "Generali",
      description: "Preferenze globali di FlickerX.",
      account: "Account",
      ...
      password: "Password",
      passwordDescription: "Cambia la password di questo account FlickerX.",
      passwordDialog: {
        ...
        setDescription:
          "Scegli la password con cui i browser remoti accedono come flickerx (almeno {minLength} caratteri). L'app desktop di FlickerX continua ad accedere automaticamente.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Disattivato da FLICKERX_HELPER_MODEL_DISABLE nell'ambiente del backend.",
        loadError:
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "Attivo tramite FLICKERX_MODEL_IDLE_TTL.",
        loadError:
      ...
      permissions: {
        ...
        bypassDescription:
          "Come FlickerX approva le chiamate agli strumenti della chat (terminale, python, web, MCP) prima che vengano eseguite. La modalità «Full access» disattiva le approvazioni e la sandbox del codice.",
      },
      notifications: {
        sectionTitle: "Notifiche",
        showLlamaUpdates: "Notifiche di aggiornamento di llama.cpp",
        showLlamaUpdatesDescription:
          "Avvisa quando è disponibile una build più recente di llama.cpp per eseguire nuovi modelli. Disattiva le notifiche se usi FlickerX solo per l'addestramento.",
      ...
      startup: {
        sectionTitle: "Avvio",
        launchAtLogin: "Avvia FlickerX all'accesso",
        launchAtLoginDescription:
          "Avvia FlickerX in background quando accedi. Rimane nella barra dei menu o nell'area di notifica finché non lo apri.",

        closeToTray: "Chiudi nell'area di notifica",
        closeToTrayDescription:
          "Mantieni FlickerX e il suo server in esecuzione in background quando chiudi la finestra principale.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Cancella solo le preferenze locali e ricarica FlickerX. Le chat, l'accesso API e le impostazioni salvate nel database restano invariati.",
        confirmAction: "Reimposta e ricarica",
      },
    },
    profile: {
      title: "Profilo",
      description: "Come appare il tuo profilo in FlickerX.",
      ...
      nickname: "Come deve chiamarti FlickerX?",
      ...
      greetingAvatar: "Avatar nel saluto",
      greetingFlickerxDescription: "Mostra il bradipo nel saluto della chat.",
      chooseAvatar: "Oppure scegli un bradipo",
      ...
      stats: {
        ...
        subtitle:
          "Tutto quello che vedi qui è calcolato dalla tua cronologia. Nessun dato viene raccolto o inviato a FlickerX.",
        retry: "Riprova",
        privacyNote:
          "Le statistiche sono calcolate dalla cronologia di chat e addestramenti presente nella tua installazione di FlickerX. Nessun dato viene raccolto né inviato a FlickerX o a terze parti.",
        emptyChats:
    ...
    appearance: {
      title: "Aspetto",
      description: "Come si presenta FlickerX su questo dispositivo.",
      theme: {
        title: "Tema",
      ...
      palette: {
        ...
        description: "Colori usati in FlickerX, nei temi chiaro e scuro.",
        standard: "Standard",
        classic: "Classica",
        minimal: "Minimale",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description:
            "Regola la dimensione di base usata nell'interfaccia di FlickerX.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "La lingua usata da FlickerX.",
    ...
    resources: {
      title: "Sistema",
      description:
        "Monitora hardware e archiviazione di questo server FlickerX.",
      ...
      llamaBackend: {
        ...
        envLocked: "Impostato su {backend} dalla variabile d'ambiente FLICKERX_LLAMA_CPP_BACKEND, che ha la precedenza su questa opzione.",
        backends: {
          auto: "Automatico",
          cpu: "CPU",
          cuda: "CUDA",
        ...
        unsupported: {
          notInstalled: "Nessuna installazione di llama.cpp gestita da FlickerX, quindi non c'è un backend da cambiare.",
          localLink: "llama.cpp è una cartella locale collegata da te, quindi FlickerX non la sostituirà.",
    ...
    agents: {
      title: "Agenti",
      description:
        "Collega agenti di programmazione come Claude Code e Codex a un modello locale con flickerx start.",
      intro:
        "collega Claude Code, Codex, Hermes, OpenClaw, OpenCode e altri agenti a un modello servito localmente da FlickerX, completamente offline. Avvia un server compatibile con le API OpenAI e non modifica i file di configurazione del tuo agente.",
      ...
      modelNote:
        "Codex richiede un modello GGUF servito da llama-server. Gli altri agenti possono usare anche modelli basati su transformer; rimuovi --model per usare il modello già caricato in FlickerX.",
      subagent: {
        title: "Usa un modello locale come subagente",
        description:
          "Mantieni {agent} sul suo modello attuale e delega alcune attività a questo modello FlickerX locale.",
        ...
        opencodePrompt: "@flickerx trova la causa di questo test che non passa",
      },
      quickstart: {
      ...
      options: {
        ...
        description:
          "I flag di FlickerX vengono interpretati per primi; tutto ciò che FlickerX non riconosce viene passato direttamente all'agente.",
        model:
          "Seleziona un modello. Senza --model, flickerx start usa il modello attualmente caricato in Studio e restituisce un errore se non ce n'è nessuno.",
        contextLength:
        ...
        persist:
          "Mantieni tra un'esecuzione e l'altra i dati dell'agente gestiti da FlickerX.",
        asSubagent:
          "Mantieni l'agente principale sul suo modello attuale e registra FlickerX come subagente locale (Claude Code, Codex e OpenCode).",
        apiKey:
          "Fornisci la tua chiave API FlickerX (oppure imposta FLICKERX_API_KEY).",
        yolo: "Salta le richieste di approvazione. Usa solo in ambienti fidati.",
      },
      remote: {
        title: "Connettersi a uno Studio remoto",
        description:
          "Punta flickerx start a uno Studio in esecuzione altrove impostando queste variabili prima dell'avvio (oppure passa direttamente --api-key):",
      },
      passthrough: {
        title: "Passare argomenti all'agente",
        description:
          "Gli argomenti che seguono i flag di FlickerX vengono inoltrati all'agente, così i comandi nativi come resume continuano a funzionare:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Accedi a FlickerX tramite le API compatibili con OpenAI.",
      ...
      secureHttpsHint:
        "La porta su 0.0.0.0 resta raggiungibile da ovunque. Per la massima sicurezza avvia FlickerX con --secure, così viene esposto solo questo link HTTPS.",
    ...
    about: {
      ...
      studioVersion: "Versione di FlickerX",
      ...
      shutDownStudio: "Arresta FlickerX",
      shutDownStudioDescription:
        "Ferma il server FlickerX e termina la tua sessione.",
      shutDown: "Arresta",
      update: {
        title: "Aggiorna FlickerX",
        ...
        checkingInstall:
          "Verifica della modalità di installazione di FlickerX...",
        installIntro: "Per installare o aggiornare FlickerX:",
        ...
        restartAfterUpdate: "Riavvia FlickerX dopo l'aggiornamento.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Esegui `flickerx studio update` nel terminale da cui hai avviato il server.",
        ...
        desktopCurrentDescription:
          "FlickerX continuerà a verificare automaticamente la disponibilità di aggiornamenti.",
        ...
        unknownInstall:
          "Impossibile rilevare come è stato installato FlickerX. Per installazioni tramite installer o PyPI, usa i comandi sopra.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "FlickerX non ha potuto confermare l'avvio dell'addestramento. La verifica dello stato continua in background.",
    ...
    trainingStart: {
      ...
      terminalStart: "> avvio dell'addestramento con FlickerX...",
