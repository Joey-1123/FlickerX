...
export const ar = {
  ...
  shell: {
    ...
    aria: {
      home: "الصفحة الرئيسية لـ FlickerX",
  ...
  settings: {
    ...
    dialog: {
      title: "الإعدادات",
      description: "إدارة تفضيلات FlickerX الخاصة بك.",
    ...
    debugging: {
      ...
      disabled: "التسجيل في ملف مُعطَّل (FLICKERX_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "مُحمَّل",
        sttUnavailable:
          "غير مثبّت على هذا الخادم. نفّذ `flickerx studio update` لتفعيل الإملاء المحلي.",
        ...
        micAccessBlocked:
          "تم حظر الوصول إلى الميكروفون. اسمح بالوصول إلى الميكروفون لصفحة FlickerX هذه ثم أعد المحاولة.",
    ...
    general: {
      title: "عام",
      description: "التفضيلات العامة لـ FlickerX.",
      account: "الحساب",
      ...
      passwordDescription: "تغيير كلمة المرور لحساب FlickerX هذا.",
      passwordDialog: {
        ...
        setDescription:
          "اختر كلمة المرور التي تسجّل بها المتصفحات البعيدة الدخول باسم flickerx (بحد أدنى {minLength} حرفًا). سيواصل تطبيق FlickerX لسطح المكتب تسجيل الدخول تلقائيًا.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "مُعطّل بواسطة FLICKERX_HELPER_MODEL_DISABLE في بيئة الخادم.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv:
          "التفريغ التلقائي عند الخمول مُفعَّل عبر متغير البيئة FLICKERX_MODEL_IDLE_TTL.",
      ...
      startup: {
        ...
        launchAtLogin: "تشغيل FlickerX عند تسجيل الدخول",
        launchAtLoginDescription:
          "يبدأ FlickerX في الخلفية عند تسجيل الدخول، ويبقى في شريط القوائم أو علبة النظام حتى تفتحه.",

        closeToTray: "الإغلاق إلى علبة النظام",
        closeToTrayDescription:
          "إبقاء FlickerX وخادمه قيد التشغيل في الخلفية عند إغلاق النافذة الرئيسية.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "يمسح التفضيلات المحلية فقط ويعيد تحميل FlickerX. تُحفظ المحادثات ووصول API والإعدادات المخزّنة في قاعدة البيانات.",
      ...
      permissions: {
        ...
        bypassDescription:
          "كيفية موافقة FlickerX على استدعاءات أدوات المحادثة (الطرفية، python، الويب، MCP) قبل تشغيلها. وضع «Full access» يعطّل الموافقات وصندوق عزل الشيفرة.",
      },
    },
    profile: {
      title: "الملف الشخصي",
      description: "كيفية ظهور ملفك الشخصي في FlickerX.",
      changePicture: "تغيير صورة الملف الشخصي",
      displayName: "الاسم المعروض",
      nickname: "بماذا يجب أن يناديك FlickerX؟",
      ...
      greetingAvatar: "الكسلان في التحية",
      greetingFlickerxDescription: "إظهار الكسلان في تحية المحادثة.",
      noPicture: "لا توجد صورة ملف شخصي",
      noneLabel: "بلا",
      stats: {
        title: "إحصاءاتك",
        subtitle:
          "كل ما يلي محسوب من سجلك الخاص. لا يُجمَع أي شيء ولا يُرسَل إلى FlickerX.",
        retry: "إعادة المحاولة",
        privacyNote:
          "تُحسب الإحصاءات من سجل المحادثات والتدريب المحفوظ في نسخة FlickerX لديك. لا يُجمَع أي شيء، ولا يُرسَل شيء إلى FlickerX أو إلى أي طرف ثالث.",
        emptyChats:
    ...
    appearance: {
      title: "المظهر",
      description: "كيفية ظهور FlickerX على هذا الجهاز.",
      theme: {
        title: "السمة",
        label: "نظام الألوان",
      ...
      palette: {
        label: "لوحة الألوان",
        description: "الألوان المستخدمة في FlickerX في الوضعين الفاتح والداكن.",
        standard: "قياسية",
        classic: "كلاسيكية",
        minimal: "بسيطة",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "اضبط الحجم الأساسي المستخدم في واجهة FlickerX.",
        },
        codeFontSize: {
      ...
      language: {
        title: "اللغة",
        label: "لغة العرض",
        description: "اللغة التي يستخدمها FlickerX.",
    ...
    resources: {
      title: "النظام",
      description: "راقب عتاد خادم FlickerX هذا ومساحة تخزينه.",
      ...
      llamaBackend: {
        ...
        envLocked: "تم ضبطها على {backend} عبر متغيّر البيئة FLICKERX_LLAMA_CPP_BACKEND، وهو يتجاوز هذا الإعداد.",
        backends: {
          auto: "تلقائي",
          cpu: "CPU",
          cuda: "CUDA",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp مجلد محلي ربطته بنفسك، ولن يستبدله FlickerX.",
    ...
    agents: {
      title: "الوكلاء",
      description:
        "اربط وكلاء البرمجة مثل Claude Code وCodex بنموذج محلي باستخدام flickerx start.",
      intro:
        "يربط Claude Code وCodex وHermes وOpenClaw وOpenCode وغيرها من الوكلاء بنموذج يقدّمه FlickerX محليًا، دون اتصال بالإنترنت تمامًا. يشغّل خادمًا متوافقًا مع OpenAI ولا يمسّ ملفات إعدادات وكيلك إطلاقًا.",
      ...
      modelNote:
        "يتطلب Codex نموذج GGUF يقدّمه llama-server. أما الوكلاء الآخرون فيمكنهم استخدام النماذج المبنية على transformers أيضًا؛ احذف ‎--model لاستخدام النموذج المُحمَّل بالفعل في FlickerX.",
      subagent: {
        title: "استخدام نموذج محلي كوكيل فرعي",
        description:
          "أبقِ {agent} على نموذجه الحالي وفوّض مهام محددة إلى نموذج FlickerX المحلي هذا.",
        ...
        opencodePrompt: "@flickerx ابحث عن سبب فشل هذا الاختبار",
      },
      quickstart: {
        title: "بناء أمر",
        description:
      ...
      options: {
        ...
        description:
          "تُحلَّل رايات FlickerX أولًا؛ وأي شيء لا يتعرّف عليه يُمرَّر كما هو إلى الوكيل.",
        model:
          "يختار نموذجًا. بدون ‎--model يستخدم flickerx start النموذج المُحمَّل حاليًا في Studio، ويُظهر خطأ إن لم يكن هناك أي نموذج محمَّل.",
        contextLength:
        ...
        persist: "يحتفظ بمساحة تخزين الوكيل التي يديرها FlickerX بين عمليات التشغيل.",
        asSubagent:
          "يبقي الوكيل الأصلي على نموذجه الحالي ويسجّل FlickerX كوكيل فرعي محلي (Claude Code وCodex وOpenCode).",
        apiKey: "يمرّر مفتاح API الخاص بـ FlickerX (أو اضبط FLICKERX_API_KEY).",
        yolo: "يتخطى طلبات الموافقة. استخدمه في البيئات الموثوقة فقط.",
      },
      remote: {
        title: "الاتصال بنسخة بعيدة من Studio",
        description:
          "وجّه flickerx start إلى نسخة من Studio تعمل في مكان آخر بضبط ما يلي قبل التشغيل (أو مرّر ‎--api-key مباشرة):",
      },
      passthrough: {
        title: "تمرير وسائط إلى الوكيل",
        description:
          "الوسائط التي تأتي بعد رايات FlickerX تُمرَّر إلى الوكيل نفسه، لذا تظل أوامره الأصلية مثل resume تعمل:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "الوصول إلى FlickerX عبر واجهة API المتوافقة مع OpenAI.",
      ...
      secureHttpsHint:
        "لا يزال المنفذ على العنوان 0.0.0.0 متاحًا عالميًا. للحصول على أمان كامل، شغّل FlickerX باستخدام --secure لإتاحة رابط HTTPS هذا فقط.",
    ...
    about: {
      ...
      shutDownStudio: "إيقاف تشغيل FlickerX",
      shutDownStudioDescription:
        "يوقف خادم FlickerX وينهي جلستك.",
      shutDown: "إيقاف التشغيل",
      update: {
        title: "تحديث FlickerX",
        commandText: "نص {label}",
        copied: "تم النسخ",
        copyCommand: "نسخ الأمر",
        commandCopied: "تم نسخ {label}",
        copyNamedCommand: "نسخ {label}",
        checkingInstall: "جارٍ التحقق من طريقة تثبيت FlickerX...",
        installIntro: "لتثبيت أو تحديث FlickerX:",
        ...
        restartAfterUpdate: "أعد تشغيل FlickerX بعد التحديث.",
        desktopManaged:
        ...
        desktopExternalServer:
          "شغّل الأمر `flickerx studio update` في الطرفية التي شغّلت الخادم.",
        ...
        desktopCurrentDescription: "سيواصل FlickerX التحقق تلقائيًا.",
        ...
        unknownInstall:
          "تعذّر اكتشاف طريقة تثبيت FlickerX. لعمليات تثبيت المثبّت أو PyPI، استخدم الأوامر أعلاه.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "تعذّر على FlickerX تأكيد بدء التدريب. جارٍ التحقق من الحالة في الخلفية.",
    ...
    trainingStart: {
      ...
      terminalStart: "> يبدأ تدريب FlickerX...",
