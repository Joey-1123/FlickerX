...
export const ru = {
  ...
  settings: {
    ...
    dialog: {
      title: "Настройки",
      description: "Управление настройками FlickerX.",
    ...
    debugging: {
      ...
      disabled: "Запись журнала в файл отключена (FLICKERX_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Загружено",
        sttUnavailable:
          "Компонент не установлен на этом сервере. Выполните `flickerx studio update`, чтобы включить локальную диктовку.",
        sttRetry: "Повторить",
        ...
        micAccessBlocked:
          "Доступ к микрофону заблокирован. Разрешите доступ к микрофону для этой страницы FlickerX и повторите попытку.",
    ...
    general: {
      title: "Общие",
      description: "Глобальные настройки FlickerX.",
      account: "Аккаунт",
      ...
      password: "Пароль",
      passwordDescription: "Изменить пароль для этого аккаунта FlickerX.",
      passwordDialog: {
        ...
        setDescription:
          "Выберите пароль, с которым удалённые браузеры входят как flickerx (не менее {minLength} символов). Настольное приложение FlickerX продолжит входить автоматически.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Отключено переменной FLICKERX_HELPER_MODEL_DISABLE в окружении бэкенда.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "Активно через FLICKERX_MODEL_IDLE_TTL.",
      ...
      startup: {
        ...
        launchAtLogin: "Запускать FlickerX при входе в систему",
        launchAtLoginDescription:
          "Запускает FlickerX в фоновом режиме при входе в систему. Приложение остаётся в строке меню или системном трее, пока вы его не откроете.",

        closeToTray: "Закрывать в системный трей",
        closeToTrayDescription:
          "Оставлять FlickerX и его сервер работающими в фоне при закрытии главного окна.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Очищает только локальные настройки и перезагружает FlickerX. Чаты, доступ по API и настройки в базе данных сохраняются.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Как FlickerX подтверждает вызовы инструментов в чате (терминал, python, веб, MCP) перед запуском. Режим «Full access» отключает подтверждения и песочницу для кода.",
      },
    },
    profile: {
      title: "Профиль",
      description: "Как ваш профиль отображается в FlickerX.",
      changePicture: "Изменить фото профиля",
      displayName: "Отображаемое имя",
      nickname: "Как FlickerX к вам обращаться?",
      ...
      chooseAvatar: "Или выберите аватар",
      ...
      greetingAvatar: "Аватар в приветствии",
      greetingFlickerxDescription: "Показывать ленивца в приветствии чата.",
      noPicture: "Нет фото профиля",
      noneLabel: "Нет",
      stats: {
        title: "Ваша статистика",
        subtitle:
          "Всё ниже считается по вашей собственной истории. Ничего не собирается и не отправляется в FlickerX.",
        retry: "Повторить",
        privacyNote:
          "Статистика рассчитывается по истории чатов и обучения, которая хранится в вашей установке FlickerX. Ничего не собирается и ничего не отправляется ни в FlickerX, ни третьим лицам.",
        emptyChats:
    ...
    appearance: {
      title: "Оформление",
      description: "Как FlickerX выглядит на этом устройстве.",
      theme: {
        title: "Тема",
      ...
      palette: {
        ...
        description: "Цвета, используемые в FlickerX в светлой и тёмной теме.",
      ...
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Настройте базовый размер шрифта интерфейса FlickerX.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "Язык, используемый FlickerX.",
    ...
    resources: {
      title: "Система",
      description: "Мониторинг оборудования и хранилища этого сервера FlickerX.",
      ...
      llamaBackend: {
        ...
        envLocked: "Значение {backend} задано переменной окружения FLICKERX_LLAMA_CPP_BACKEND, она важнее этой настройки.",
        backends: {
          auto: "Автоматически",
          cpu: "CPU",
          cuda: "CUDA",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp, это локальный каталог, который вы подключили сами, и FlickerX его не заменяет.",
    ...
    agents: {
      title: "Агенты",
      description:
        "Подключение кодинг-агентов, таких как Claude Code и Codex, к локальной модели с помощью flickerx start.",
      intro:
        "подключает Claude Code, Codex, Hermes, OpenClaw, OpenCode и других агентов к модели, которую FlickerX обслуживает локально, полностью офлайн. Запускается OpenAI-совместимый сервер, а файлы конфигурации вашего агента остаются нетронутыми.",
      ...
      modelNote:
        "Codex требует модель GGUF, обслуживаемую llama-server. Другие агенты могут работать и с моделями на основе transformers; уберите --model, чтобы использовать модель, уже загруженную в FlickerX.",
      subagent: {
        title: "Использовать локальную модель в качестве субагента",
        description:
          "Оставьте {agent} на текущей модели и делегируйте отдельные задачи этой локальной модели FlickerX.",
        ...
        opencodePrompt: "@flickerx найди причину этого падения теста",
      },
      quickstart: {
      ...
      options: {
        ...
        description:
          "Сначала разбираются флаги FlickerX; всё, что не распознано, передаётся агенту без изменений.",
        model:
          "Выбирает модель. Без --model команда flickerx start использует модель, уже загруженную в Studio, и завершается ошибкой, если модели нет.",
        contextLength:
        ...
        persist:
          "Сохраняет между запусками хранилище агента, управляемое FlickerX.",
        asSubagent:
          "Оставляет родительского агента на текущей модели и регистрирует FlickerX как локального субагента (Claude Code, Codex и OpenCode).",
        apiKey:
          "Передаёт ваш ключ API FlickerX (альтернатива: переменная FLICKERX_API_KEY).",
        yolo:
      ...
      remote: {
        ...
        description:
          "Чтобы подключить flickerx start к удалённому экземпляру Studio, задайте перед запуском следующие переменные (или передайте --api-key напрямую):",
      },
      passthrough: {
        title: "Передача аргументов агенту",
        description:
          "Аргументы после флагов FlickerX передаются самому агенту, поэтому его собственные команды вроде resume продолжают работать:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Доступ к FlickerX через OpenAI-совместимый API.",
      ...
      secureHttpsHint:
        "Порт, привязанный к адресу 0.0.0.0, по-прежнему доступен глобально. Для полной безопасности запустите FlickerX с флагом --secure, чтобы оставить доступ только по этой HTTPS-ссылке.",
    ...
    about: {
      ...
      shutDownStudio: "Выключить FlickerX",
      shutDownStudioDescription:
        "Останавливает сервер FlickerX и завершает вашу сессию.",
      shutDown: "Выключить",
      update: {
        title: "Обновить FlickerX",
        commandText: "Текст «{label}»",
        copied: "Скопировано",
        copyCommand: "Копировать команду",
        commandCopied: "Скопировано: {label}",
        copyNamedCommand: "Копировать «{label}»",
        checkingInstall: "Проверка способа установки FlickerX...",
        installIntro: "Чтобы установить или обновить FlickerX:",
        ...
        localInstallDetected:
          "Обнаружена установка из локальной рабочей копии. Обновляйте FlickerX из исходной рабочей копии, чтобы не заменить эту установку пакетом из PyPI.",
        pullThenUpdate:
        ...
        restartAfterUpdate: "После обновления перезапустите FlickerX.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Выполните `flickerx studio update` в терминале, из которого был запущен сервер.",
        ...
        desktopCurrentDescription:
          "FlickerX продолжит автоматически проверять наличие обновлений.",
        ...
        unknownInstall:
          "Не удалось определить способ установки FlickerX. Для установки через установщик или PyPI используйте команды выше.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "FlickerX не удалось подтвердить запуск обучения. Состояние проверяется в фоновом режиме.",
    ...
    trainingStart: {
      ...
      terminalStart: "> обучение flickerx начинается...",
