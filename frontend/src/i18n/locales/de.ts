...
export const de = {
  ...
  settings: {
    ...
    dialog: {
      title: "Einstellungen",
      description: "Verwalten Sie Ihre FlickerX-Einstellungen.",
    ...
    debugging: {
      ...
      disabled: "Die Protokollierung in eine Datei ist deaktiviert (FLICKERX_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Geladen",
        sttUnavailable:
          "Auf diesem Server nicht installiert. Führen Sie `flickerx studio update` aus, um das lokale Diktat zu aktivieren.",
        ...
        micAccessBlocked:
          "Der Mikrofonzugriff wurde blockiert. Erlauben Sie den Mikrofonzugriff für diese FlickerX-Seite und versuchen Sie es erneut.",
    ...
    general: {
      title: "Allgemein",
      description: "Globale Einstellungen für FlickerX.",
      account: "Konto",
      ...
      password: "Passwort",
      passwordDescription:
        "Ändern Sie das Passwort für dieses FlickerX-Konto.",
      passwordDialog: {
        ...
        setDescription:
          "Wählen Sie das Passwort, mit dem sich entfernte Browser als flickerx anmelden (mindestens {minLength} Zeichen). Die FlickerX Desktop-App meldet sich weiterhin automatisch an.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Deaktiviert durch FLICKERX_HELPER_MODEL_DISABLE in der Backend-Umgebung.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv:
          "Automatisches Entladen bei Inaktivität ist über die Umgebungsvariable FLICKERX_MODEL_IDLE_TTL aktiv.",
        loadError:
      ...
      startup: {
        ...
        launchAtLogin: "FlickerX bei der Anmeldung starten",
        launchAtLoginDescription:
          "Startet FlickerX im Hintergrund, wenn Sie sich anmelden. Es bleibt in der Menüleiste bzw. im Infobereich, bis Sie es öffnen.",

        closeToTray: "In den Infobereich schließen",
        closeToTrayDescription:
          "FlickerX und seinen Server im Hintergrund weiterlaufen lassen, wenn Sie das Hauptfenster schließen.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Löscht nur lokal gespeicherte Einstellungen und lädt FlickerX neu. Chats, API-Zugriff und in der DB gespeicherte Einstellungen bleiben erhalten.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Wie FlickerX Tool-Aufrufe im Chat (Terminal, Python, Web, MCP) vor der Ausführung freigibt. „Full access“ deaktiviert die Freigaben und die Code-Sandbox.",
      },
    },
    profile: {
      title: "Profil",
      description: "Wie Ihr Profil in FlickerX angezeigt wird.",
      changePicture: "Profilbild ändern",
      displayName: "Anzeigename",
      nickname: "Wie soll FlickerX Sie nennen?",
      ...
      chooseAvatar: "Oder wählen Sie ein Avatar",
      ...
      greetingAvatar: "Avatar in der Begrüßung",
      greetingFlickerxDescription: "Das Avatar in der Chat-Begrüßung anzeigen.",
      noPicture: "Kein Profilbild",
      noneLabel: "Keines",
      stats: {
        title: "Ihre Statistiken",
        subtitle:
          "Alles Folgende wird aus Ihrem eigenen Verlauf berechnet. Es wird nichts erfasst oder an FlickerX gesendet.",
        retry: "Erneut versuchen",
        privacyNote:
          "Die Statistiken werden aus dem Chat- und Trainingsverlauf berechnet, der in Ihrer FlickerX-Installation gespeichert ist. Es wird nichts erfasst und nichts an FlickerX oder Dritte gesendet.",
        emptyChats:
    ...
    appearance: {
      title: "Darstellung",
      description: "Wie FlickerX auf diesem Gerät aussieht.",
      theme: {
        title: "Design",
        label: "Farbschema",
      ...
      palette: {
        label: "Farbpalette",
        description: "Farben, die in FlickerX im hellen und dunklen Modus verwendet werden.",
        standard: "Standard",
        classic: "Klassisch",
        minimal: "Minimal",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Passen Sie die Grundgröße der FlickerX-Oberfläche an.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "Die von FlickerX verwendete Sprache.",
    ...
    resources: {
      title: "System",
      description:
        "Überwachen Sie Hardware und Speicher dieses FlickerX-Servers.",
      ...
      llamaBackend: {
        ...
        envLocked: "Durch die Umgebungsvariable FLICKERX_LLAMA_CPP_BACKEND auf {backend} festgelegt; sie überschreibt diese Einstellung.",
        backends: {
          auto: "Automatisch",
          cpu: "CPU",
          cuda: "CUDA",
        ...
        unsupported: {
          notInstalled: "Es wurde keine von FlickerX verwaltete llama.cpp-Installation gefunden, daher gibt es kein Backend zum Wechseln.",
          localLink: "llama.cpp ist ein selbst verknüpftes lokales Verzeichnis, das FlickerX nicht ersetzt.",
    ...
    agents: {
      title: "Agenten",
      description:
        "Verbinden Sie Coding-Agenten wie Claude Code und Codex über flickerx start mit einem lokalen Modell.",
      intro:
        "verbindet Claude Code, Codex, Hermes, OpenClaw, OpenCode und weitere Agenten mit einem lokal von FlickerX bereitgestellten Modell, vollständig offline. Es startet einen OpenAI-kompatiblen Server und verändert nie die Konfigurationsdateien Ihres Agenten.",
      ...
      modelNote:
        "Codex benötigt ein GGUF-Modell, das von llama-server bereitgestellt wird. Andere Agenten können auch Transformer-basierte Modelle verwenden; lassen Sie --model weg, um das bereits in FlickerX geladene Modell zu nutzen.",
      subagent: {
        title: "Ein lokales Modell als Subagent verwenden",
        description:
          "Belassen Sie {agent} bei seinem aktuellen Modell und delegieren Sie ausgewählte Aufgaben an dieses lokale FlickerX-Modell.",
        ...
        opencodePrompt: "@flickerx finde die Ursache dieses Testfehlers",
      },
      quickstart: {
      ...
      options: {
        ...
        description:
          "FlickerX-Optionen werden zuerst ausgewertet; alles Unbekannte wird unverändert an den Agenten weitergereicht.",
        model:
          "Wählt ein Modell aus. Ohne --model verwendet flickerx start das aktuell in Studio geladene Modell und bricht mit einem Fehler ab, wenn keines geladen ist.",
        contextLength:
        ...
        persist:
          "Behält die von FlickerX verwalteten Agent-Daten über Läufe hinweg bei.",
        asSubagent:
          "Belässt den übergeordneten Agenten bei seinem aktuellen Modell und registriert FlickerX als lokalen Subagenten (Claude Code, Codex und OpenCode).",
        apiKey:
          "Übergibt Ihren FlickerX-API-Schlüssel (alternativ FLICKERX_API_KEY setzen).",
        yolo:
      ...
      remote: {
        ...
        description:
          "Richten Sie flickerx start auf ein anderswo laufendes Studio aus, indem Sie diese Variablen vor dem Aufruf setzen (oder --api-key direkt übergeben):",
      },
      passthrough: {
        title: "Argumente an den Agenten übergeben",
        description:
          "Argumente nach den FlickerX-Optionen werden an den Agenten selbst weitergereicht, sodass native Befehle wie resume weiterhin funktionieren:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Zugriff auf FlickerX über die OpenAI-kompatible API.",
      ...
      secureHttpsHint:
        "Der 0.0.0.0-Port ist weiterhin global erreichbar. Für vollständige Sicherheit starten Sie FlickerX mit --secure, um nur diesen HTTPS-Link freizugeben.",
    ...
    about: {
      ...
      studioVersion: "FlickerX-Version",
      ...
      license: {
        sectionTitle: "Lizenz",
        studioLabel: "FlickerX",
        studioLicense: "AGPL-3.0",
        studioDescription: "Open Source unter der GNU AGPL v3.0.",
        libraryLabel: "FlickerX Core",
        libraryLicense: "Apache-2.0",
        libraryDescription: "Lizenziert unter Apache 2.0.",
      },
      dangerZone: "Gefahrenzone",
      shutDownStudio: "FlickerX herunterfahren",
      shutDownStudioDescription:
        "Stoppt den FlickerX-Server und beendet Ihre Sitzung.",
      shutDown: "Herunterfahren",
      update: {
        title: "FlickerX aktualisieren",
        commandText: "{label} als Text",
        copied: "Kopiert",
        copyCommand: "Befehl kopieren",
        commandCopied: "{label} kopiert",
        copyNamedCommand: "{label} kopieren",
        checkingInstall: "Es wird geprüft, wie FlickerX installiert wurde...",
        installIntro: "So installieren oder aktualisieren Sie FlickerX:",
        ...
        restartAfterUpdate: "Starten Sie FlickerX nach dem Update neu.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Führen Sie `flickerx studio update` in dem Terminal aus, über das Sie Ihren Server gestartet haben.",
        ...
        desktopCurrentDescription:
          "FlickerX sucht weiterhin automatisch nach Updates.",
        ...
        unknownInstall:
          "Es konnte nicht erkannt werden, wie FlickerX installiert wurde. Verwenden Sie für Installer- oder PyPI-Installationen die obigen Befehle.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "FlickerX konnte nicht bestätigen, ob das Training gestartet wurde. Der Status wird im Hintergrund geprüft.",
    ...
    trainingStart: {
      ...
      terminalStart: "> FlickerX-Training beginnt...",
