...
export const es = {
  ...
  settings: {
    ...
    dialog: {
      title: "Configuración",
      description: "Gestiona tus preferencias de FlickerX.",
    ...
    debugging: {
      ...
      disabled: "El registro en archivo está desactivado (FLICKERX_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Cargado",
        sttUnavailable:
          "No está instalado en este servidor. Ejecuta `flickerx studio update` para habilitar el dictado local.",
        sttRetry: "Reintentar",
        ...
        micAccessBlocked:
          "Se bloqueó el acceso al micrófono. Permite el acceso al micrófono para esta página de FlickerX e inténtalo de nuevo.",
    ...
    general: {
      title: "General",
      description: "Preferencias globales de FlickerX.",
      account: "Cuenta",
      ...
      password: "Contraseña",
      passwordDescription:
        "Cambia la contraseña de esta cuenta de FlickerX.",
      passwordDialog: {
        ...
        setDescription:
          "Elige la contraseña con la que los navegadores remotos inician sesión como flickerx (al menos {minLength} caracteres). La app de escritorio de FlickerX sigue iniciando sesión automáticamente.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Desactivado por FLICKERX_HELPER_MODEL_DISABLE en el entorno del backend.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv:
          "La descarga automática por inactividad está activa mediante la variable de entorno FLICKERX_MODEL_IDLE_TTL.",
        loadError:
      ...
      startup: {
        sectionTitle: "Inicio",
        launchAtLogin: "Ejecutar FlickerX al iniciar sesión",
        launchAtLoginDescription:
          "Inicia FlickerX en segundo plano cuando inicias sesión. Permanece en la barra de menús o en la bandeja del sistema hasta que lo abras.",

        closeToTray: "Cerrar en la bandeja del sistema",
        closeToTrayDescription:
          "Mantén FlickerX y su servidor ejecutándose en segundo plano al cerrar la ventana principal.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Borra las preferencias solo locales y recarga FlickerX. Se conservan los chats, el acceso a la API y la configuración almacenada en la base de datos.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Cómo aprueba FlickerX las llamadas a herramientas del chat (terminal, python, web, MCP) antes de ejecutarlas. El modo «Full access» desactiva las aprobaciones y el sandbox de código.",
      },
    },
    profile: {
      title: "Perfil",
      description: "Cómo aparece tu perfil en FlickerX.",
      changePicture: "Cambiar foto de perfil",
      displayName: "Nombre visible",
      nickname: "¿Cómo debería llamarte FlickerX?",
      ...
      chooseAvatar: "O elige un perezoso",
      ...
      greetingAvatar: "Perezoso en el saludo",
      greetingFlickerxDescription: "Muestra el perezoso en el saludo del chat.",
      noPicture: "Sin foto de perfil",
      noneLabel: "Ninguno",
      stats: {
        title: "Tus estadísticas",
        subtitle:
          "Todo lo que aparece a continuación se calcula a partir de tu propio historial. No se recopila ni se envía nada a FlickerX.",
        retry: "Volver a intentar",
        privacyNote:
          "Las estadísticas se calculan a partir del historial de chats y entrenamientos que guarda tu instalación de FlickerX. No se recopila nada y no se envía nada a FlickerX ni a terceros.",
        emptyChats:
    ...
    appearance: {
      title: "Apariencia",
      description: "Cómo se ve FlickerX en este dispositivo.",
      theme: {
        title: "Tema",
      ...
      palette: {
        ...
        description: "Colores usados en FlickerX, en modo claro y oscuro.",
        standard: "Estándar",
        classic: "Clásica",
        minimal: "Minimalista",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Ajusta el tamaño base usado en la interfaz de FlickerX.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "El idioma que usa FlickerX.",
    ...
    resources: {
      title: "Sistema",
      description:
        "Monitorea el hardware y el almacenamiento de este servidor de FlickerX.",
      ...
      llamaBackend: {
        ...
        envLocked: "Fijado en {backend} por la variable de entorno FLICKERX_LLAMA_CPP_BACKEND, que tiene prioridad sobre este ajuste.",
        backends: {
          auto: "Automático",
          cpu: "CPU",
          cuda: "CUDA",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp es un directorio local que enlazaste tú, así que FlickerX no lo reemplazará.",
    ...
    agents: {
      title: "Agentes",
      description:
        "Conecta agentes de programación como Claude Code y Codex a un modelo local con flickerx start.",
      intro:
        "conecta Claude Code, Codex, Hermes, OpenClaw, OpenCode y otros agentes a un modelo servido localmente por FlickerX, totalmente sin conexión. Ejecuta un servidor compatible con OpenAI y nunca modifica los archivos de configuración de tu agente.",
      ...
      modelNote:
        "Codex requiere un modelo GGUF servido por llama-server. Otros agentes también pueden usar modelos basados en transformers; quita --model para usar el modelo ya cargado en FlickerX.",
      subagent: {
        title: "Usar un modelo local como subagente",
        description:
          "Mantén {agent} en su modelo actual y delega tareas concretas en este modelo local de FlickerX.",
        ...
        opencodePrompt: "@flickerx encuentra la causa de este fallo en las pruebas",
      },
      quickstart: {
      ...
      options: {
        ...
        description:
          "Primero se procesan las opciones de FlickerX; todo lo que FlickerX no reconoce se pasa directamente al agente.",
        model:
          "Selecciona un modelo. Sin --model, flickerx start usa el modelo cargado actualmente en Studio y da error si no hay ninguno.",
        contextLength:
        ...
        persist:
          "Conserva entre ejecuciones el almacenamiento de agentes que gestiona FlickerX.",
        asSubagent:
          "Mantén el agente principal en su modelo actual y registra FlickerX como subagente local (Claude Code, Codex y OpenCode).",
        apiKey: "Indica tu clave de API de FlickerX (o define FLICKERX_API_KEY).",
        yolo:
      ...
      remote: {
        ...
        description:
          "Apunta flickerx start a un Studio que se ejecuta en otro lugar definiendo estas variables antes de iniciar el agente (o pasa --api-key directamente):",
      },
      passthrough: {
        title: "Pasar argumentos al agente",
        description:
          "Los argumentos que van después de las opciones de FlickerX se reenvían al propio agente, así que comandos nativos como resume siguen funcionando:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Accede a FlickerX mediante la API compatible con OpenAI.",
      ...
      secureHttpsHint:
        "El puerto 0.0.0.0 sigue siendo accesible globalmente. Para máxima seguridad, inicia FlickerX con --secure para exponer solo este enlace HTTPS.",
    ...
    about: {
      ...
      studioVersion: "Versión de FlickerX",
      ...
      shutDownStudio: "Apagar FlickerX",
      shutDownStudioDescription:
        "Detiene el servidor de FlickerX y finaliza tu sesión.",
      shutDown: "Apagar",
      update: {
        title: "Actualizar FlickerX",
        commandText: "Texto de {label}",
        copied: "Copiado",
        copyCommand: "Copiar comando",
        commandCopied: "{label} copiado",
        copyNamedCommand: "Copiar {label}",
        checkingInstall: "Comprobando cómo se instaló FlickerX...",
        installIntro: "Para instalar o actualizar FlickerX:",
        ...
        restartAfterUpdate: "Reinicia FlickerX después de actualizar.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Ejecuta `flickerx studio update` desde el terminal que inició el servidor.",
        ...
        desktopCurrentDescription:
          "FlickerX seguirá buscando actualizaciones automáticamente.",
        ...
        unknownInstall:
          "No se pudo detectar cómo se instaló FlickerX. Para instalaciones con el instalador o desde PyPI, usa los comandos anteriores.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "FlickerX no pudo confirmar si el entrenamiento se inició. Se está comprobando el estado en segundo plano.",
    ...
    trainingStart: {
      ...
      terminalStart: "> el entrenamiento de flickerx comienza...",
