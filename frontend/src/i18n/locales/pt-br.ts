...
export const ptBR = {
  ...
  settings: {
    ...
    dialog: {
      title: "Configurações",
      description: "Gerencie suas preferências do FlickerX.",
    ...
    debugging: {
      ...
      disabled: "O log em arquivo está desativado (FLICKERX_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Carregado",
        sttUnavailable:
          "Não instalado neste servidor. Execute `flickerx studio update` para habilitar o ditado local.",
        ...
        micAccessBlocked:
          "O acesso ao microfone foi bloqueado. Permita o acesso ao microfone nesta página do FlickerX e tente novamente.",
    ...
    general: {
      title: "Geral",
      description: "Preferências globais do FlickerX.",
      account: "Conta",
      ...
      password: "Senha",
      passwordDescription: "Altere a senha desta conta do FlickerX.",
      passwordDialog: {
        ...
        setDescription:
          "Escolha a senha que os navegadores remotos usam para entrar como flickerx (no mínimo {minLength} caracteres). O aplicativo de desktop da FlickerX continua entrando automaticamente.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Desativado por FLICKERX_HELPER_MODEL_DISABLE no ambiente de backend.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "Ativo por meio de FLICKERX_MODEL_IDLE_TTL.",
      ...
      startup: {
        ...
        launchAtLogin: "Executar o FlickerX ao fazer login",
        launchAtLoginDescription:
          "Inicia o FlickerX em segundo plano quando você faz login. Ele permanece na barra de menus ou na bandeja do sistema até você abri-lo.",

        closeToTray: "Fechar para a bandeja do sistema",
        closeToTrayDescription:
          "Mantém o FlickerX e seu servidor em execução em segundo plano ao fechar a janela principal.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Limpa as preferências locais e recarrega o FlickerX. Chats, acesso à API e configurações salvas no banco de dados são mantidos.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Como o FlickerX aprova as chamadas de ferramentas do chat (terminal, python, web, MCP) antes de executá-las. O modo “Full access” desativa as aprovações e o sandbox de código.",
      },
    },
    profile: {
      title: "Perfil",
      description: "Como seu perfil aparece no FlickerX.",
      changePicture: "Alterar foto de perfil",
      displayName: "Nome de exibição",
      nickname: "Como o FlickerX deve chamar você?",
      ...
      greetingAvatar: "Avatar na saudação",
      greetingFlickerxDescription: "Mostra o avatar na saudação do chat.",
      chooseAvatar: "Ou escolha um avatar",
      ...
      stats: {
        ...
        subtitle:
          "Tudo abaixo é calculado a partir do seu próprio histórico. Nada é coletado nem enviado ao FlickerX.",
        retry: "Tentar novamente",
        privacyNote:
          "As estatísticas são calculadas a partir do histórico de chats e de treinos guardado pela sua instalação do FlickerX. Nada é coletado e nada é enviado ao FlickerX ou a terceiros.",
        emptyChats:
    ...
    appearance: {
      title: "Aparência",
      description: "A aparência do FlickerX neste dispositivo.",
      theme: {
        title: "Tema",
      ...
      palette: {
        ...
        description: "Cores usadas no FlickerX, nos modos claro e escuro.",
        standard: "Padrão",
        classic: "Clássico",
        minimal: "Minimalista",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Ajuste o tamanho base da interface do FlickerX.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "O idioma utilizado pelo FlickerX.",
    ...
    resources: {
      title: "Sistema",
      description: "Monitore o hardware e o armazenamento deste servidor FlickerX.",
      ...
      llamaBackend: {
        ...
        envLocked: "Set to {backend} by the FLICKERX_LLAMA_CPP_BACKEND environment variable, which overrides this setting.",
        backends: {
          auto: "Automatic",
          cpu: "CPU",
          cuda: "CUDA",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp is a local directory you linked yourself, so FlickerX will not replace it.",
    ...
    agents: {
      title: "Agentes",
      description:
        "Conecte agentes de código como Claude Code e Codex a um modelo local com flickerx start.",
      intro:
        "conecta Claude Code, Codex, Hermes, OpenClaw, OpenCode e outros agentes a um modelo servido localmente pelo FlickerX, totalmente offline. Ele executa um servidor compatível com a API da OpenAI e nunca altera os arquivos de configuração do seu agente.",
      ...
      modelNote:
        "O Codex exige um modelo GGUF servido pelo llama-server. Outros agentes também podem usar modelos baseados em transformers; remova --model para usar o modelo já carregado no FlickerX.",
      subagent: {
        title: "Usar um modelo local como subagente",
        description:
          "Mantenha o {agent} no modelo atual e delegue tarefas selecionadas a este modelo local do FlickerX.",
        ...
        opencodePrompt: "@flickerx encontre a causa desta falha de teste",
      },
      quickstart: {
      ...
      options: {
        title: "Opções comuns",
        description:
          "As flags do FlickerX são interpretadas primeiro; tudo o que ele não reconhecer é repassado direto ao agente.",
        model:
          "Seleciona um modelo. Sem --model, o flickerx start usa o modelo carregado no Studio e retorna erro se não houver nenhum.",
        contextLength:
        ...
        persist:
          "Mantém entre execuções o armazenamento de agentes gerenciado pelo FlickerX.",
        asSubagent:
          "Mantém o agente principal no modelo atual e registra o FlickerX como subagente local (Claude Code, Codex e OpenCode).",
        apiKey:
          "Informa sua chave de API do FlickerX (ou defina FLICKERX_API_KEY).",
        yolo: "Pula os pedidos de aprovação. Use apenas em ambientes confiáveis.",
      },
      remote: {
        title: "Conectar a um Studio remoto",
        description:
          "Aponte o flickerx start para um Studio em execução em outro lugar, definindo estas variáveis antes de iniciar (ou passe --api-key diretamente):",
      },
      passthrough: {
        title: "Repassar argumentos ao agente",
        description:
          "Os argumentos após as flags do FlickerX são encaminhados ao próprio agente, então comandos nativos como resume continuam funcionando:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description:
        "Acesse o FlickerX por meio da API compatível com OpenAI.",
      ...
      secureHttpsHint:
        "O endereço 0.0.0.0 ainda está acessível globalmente. Para segurança total, inicie o FlickerX com --secure para expor apenas este link HTTPS.",
    ...
    about: {
      ...
      studioVersion: "Versão do FlickerX",
      ...
      shutDownStudio: "Desligar o FlickerX",
      shutDownStudioDescription:
        "Interrompe o servidor FlickerX e encerra sua sessão.",
      shutDown: "Desligar",
      update: {
        title: "Atualizar FlickerX",
        commandText: "Texto de {label}",
        copied: "Copiado",
        copyCommand: "Copiar comando",
        commandCopied: "{label} copiado",
        copyNamedCommand: "Copiar {label}",
        checkingInstall: "Verificando como o FlickerX foi instalado...",
        installIntro: "Para instalar ou atualizar o FlickerX:",
        ...
        restartAfterUpdate: "Reinicie o FlickerX após a atualização.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Execute `flickerx studio update` no terminal usado para iniciar o servidor.",
        ...
        desktopCurrentDescription:
          "O FlickerX continuará verificando automaticamente.",
        ...
        unknownInstall:
          "Não foi possível detectar como o FlickerX foi instalado. Para instalações via instalador ou PyPI, use os comandos acima.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "O FlickerX não conseguiu confirmar se o treinamento foi iniciado. O status está sendo verificado em segundo plano.",
    ...
    trainingStart: {
      ...
      terminalStart: "> treinamento do flickerx iniciado...",
