...
export const ja = {
  ...
  settings: {
    ...
    dialog: {
      title: "設定",
      description: "FlickerX の環境設定を管理します。",
    ...
    debugging: {
      ...
      empty: "まだ何も記録されていません。",
      disabled: "ファイルへのログ出力は無効です (FLICKERX_STUDIO_NO_FILE_LOG=1)。",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "読み込み済み",
        sttUnavailable:
          "このサーバーにはインストールされていません。ローカルの音声入力を有効にするには `flickerx studio update` を実行してください。",
        sttRetry: "再試行",
        ...
        micAccessBlocked:
          "マイクへのアクセスがブロックされました。この FlickerX のページでマイクへのアクセスを許可してから、もう一度お試しください。",
    ...
    general: {
      ...
      password: "パスワード",
      passwordDescription: "この FlickerX アカウントのパスワードを変更します。",
      passwordDialog: {
        trigger: "パスワード変更",
        title: "パスワード変更",
        ...
        setDescription: "リモートのブラウザーが flickerx としてサインインするためのパスワード（最低 {minLength} 文字）を選んでください。FlickerX デスクトップアプリは引き続き自動でサインインします。",
        setSubmit: "パスワードを設定",
        setting: "設定中...",
      ...
      helperLlm: {
        ...
        disabledByEnv: "バックエンド環境の FLICKERX_HELPER_MODEL_DISABLE によって無効化されています。",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "アイドル時の自動アンロードは FLICKERX_MODEL_IDLE_TTL 環境変数によって有効になっています。",
      ...
      startup: {
        sectionTitle: "起動",
        launchAtLogin: "ログイン時に FlickerX を起動",
        launchAtLoginDescription:
          "ログイン時に FlickerX をバックグラウンドで起動します。開くまでメニューバーまたはシステムトレイに常駐します。",

        closeToTray: "システムトレイに格納して閉じる",
        closeToTrayDescription:
          "メインウィンドウを閉じても、FlickerX とサーバーをバックグラウンドで実行し続けます。",
      ...
      resetPreferences: {
        ...
        confirmDescription: "ローカル限定の設定を消去し、FlickerX を再読み込みします。チャット、APIアクセス、DBに保存された設定は保持されます。",
      ...
      permissions: {
        ...
        bypassLabel: "ツールの権限",
        bypassDescription:
          "チャットのツール呼び出し (ターミナル、python、ウェブ、MCP) を実行する前に、FlickerX がどのように承認するかを決めます。「Full access」にすると承認とコードサンドボックスが無効になります。",
      },
    },
    profile: {
      title: "プロフィール",
      description: "FlickerX 内でのプロフィールの表示方法。",
      changePicture: "プロフィール写真を変更",
      displayName: "表示名",
      nickname: "FlickerX での呼び名",
      nicknamePlaceholder: "ニックネーム",
      nicknameSaved: "希望する名前を保存しました",
      avatarShape: "プロフィール写真の形状",
      avatarShapeCircle: "円形",
      avatarShapeRounded: "角丸",
      greetingAvatar: "挨拶にアバターを表示",
      greetingFlickerxDescription: "チャットの挨拶にアバターを表示します。",
      chooseAvatar: "またはアバターのプロフィール画像を選択",
      ...
      stats: {
        title: "あなたの統計",
        subtitle:
          "以下はすべてご自身の履歴から集計しています。収集も FlickerX への送信も行いません。",
        retry: "再試行",
        privacyNote:
          "統計は、お使いの FlickerX が保持しているチャットとトレーニングの履歴から計算されます。データの収集は行わず、FlickerX や第三者への送信も行いません。",
        emptyChats:
    ...
    appearance: {
      title: "外観",
      description: "このデバイスでの FlickerX の見た目。",
      theme: {
        title: "テーマ",
        label: "カラー構成",
      ...
      palette: {
        label: "カラーパレット",
        description: "FlickerX 全体で使用される配色。ライト・ダーク両対応。",
        standard: "スタンダード",
        classic: "クラシック",
        minimal: "ミニマル",
      },
      custom: {
        ...
        uiFontSize: {
          label: "UI フォントサイズ",
          description: "FlickerX UI の基本サイズを調整します。",
        },
        codeFontSize: {
          label: "コードフォントサイズ",
    ...
    resources: {
      title: "システム",
      description: "この FlickerX サーバーのハードウェアとストレージを監視します。",
      ...
      llamaBackend: {
        ...
        envLocked: "環境変数 FLICKERX_LLAMA_CPP_BACKEND により {backend} に固定されています。この設定より優先されます。",
        backends: {
          auto: "自動",
          cpu: "CPU",
          cuda: "CUDA",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp は自分でリンクしたローカルディレクトリのため、FlickerX は置き換えません。",
    ...
    agents: {
      title: "エージェント",
      description:
        "flickerx start で Claude Code や Codex などのコーディングエージェントをローカルモデルに接続します。",
      intro:
        "は Claude Code、Codex、Hermes、OpenClaw、OpenCode などのエージェントを、FlickerX がローカルで提供するモデルに完全オフラインで接続します。OpenAI 互換サーバーを起動し、エージェントの設定ファイルには一切手を加えません。",
      readDocs: "ドキュメントを読む",
      copy: "コピー",
      copied: "コピーしました",
      ...
      modelNote:
        "Codex には llama-server が提供する GGUF モデルが必要です。他のエージェントは transformers ベースのモデルも利用できます。FlickerX に読み込み済みのモデルを使うには --model を外してください。",
      subagent: {
        title: "ローカルモデルをサブエージェントとして使う",
        description:
          "{agent} は現在のモデルのまま、選んだタスクだけをこのローカルの FlickerX モデルに委任します。",
        ...
        opencodePrompt: "@flickerx このテスト失敗の原因を調べて",
      },
      quickstart: {
        title: "コマンドを組み立てる",
        description:
      ...
      options: {
        title: "主なオプション",
        description:
          "FlickerX のフラグが先に解釈され、認識されなかったものはそのままエージェントへ渡されます。",
        model:
          "モデルを選択します。--model がない場合、flickerx start は Studio に読み込み済みのモデルを使用し、未読み込みならエラーになります。",
        contextLength:
        ...
        persist:
          "FlickerX が管理するエージェントのストレージを実行間で保持します。",
        asSubagent:
          "親エージェントを現在のモデルのままにし、FlickerX をローカルのサブエージェントとして登録します (Claude Code、Codex、OpenCode)。",
        apiKey:
          "FlickerX の API キーを指定します (または FLICKERX_API_KEY を設定)。",
        yolo:
      ...
      remote: {
        ...
        description:
          "起動前に次を設定すると、flickerx start を別の場所で動作している Studio に向けられます (--api-key を直接渡すことも可能です):",
      },
      passthrough: {
        title: "エージェントへの引数の受け渡し",
        description:
          "FlickerX のフラグより後ろの引数はエージェント自身へ転送されるため、resume のようなネイティブコマンドもそのまま使えます:",
      },
      dryRun: {
        title: "起動せずに内容を確認する",
        description:
    ...
    apiKeys: {
      title: "API",
      description: "OpenAI互換 API を介して FlickerX にアクセスします。",
      ...
      secureHttpsHint: "0.0.0.0 ポートは依然としてグローバルにアクセス可能です。完全なセキュリティを確保するには、FlickerX を --secure 付きで起動し、この HTTPS リンクのみを公開してください。",
    ...
    about: {
      ...
      dangerZone: "危険ゾーン",
      shutDownStudio: "FlickerX をシャットダウン",
      shutDownStudioDescription: "FlickerX サーバーを停止し、セッションを終了します。",
      shutDown: "シャットダウン",
      update: {
        title: "FlickerX のアップデート",
        commandText: "{label}のテキスト",
        copied: "コピーしました",
        copyCommand: "コマンドをコピー",
        commandCopied: "{label} をコピーしました",
        copyNamedCommand: "{label} をコピー",
        checkingInstall: "FlickerX がどのようにインストールされたかを確認中...",
        installIntro: "FlickerX のインストールまたはアップデート方法:",
        ...
        restartAfterUpdate: "アップデート後に FlickerX を再起動してください。",
        desktopManaged:
        ...
        desktopExternalServer:
          "サーバーを起動したターミナルで `flickerx studio update` を実行してください。",
        ...
        unknownInstall: "FlickerX がどのようにインストールされたか検出できませんでした。インストーラーまたは PyPI インストールの場合は、上記のコマンドを使用してください。",
        localCheckout:
  ...
  studio: {
    ...
    trainingStart: {
      ...
      terminalStart: "> flickerx トレーニングを開始します...",
