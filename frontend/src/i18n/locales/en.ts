...
export const en = {
  ...
  settings: {
    ...
    dialog: {
      title: "Settings",
      description: "Manage your FlickerX preferences.",
    ...
    debugging: {
      ...
      disabled: "File logging is turned off (FLICKERX_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Loaded",
        sttUnavailable:
          "Not installed on this server. Run `flickerx studio update` to enable local dictation.",
        sttRetry: "Retry",
        ...
        micAccessBlocked:
          "Microphone access was blocked. Allow microphone access for this FlickerX page, then try again.",
    ...
    general: {
      title: "General",
      description: "Global preferences for FlickerX.",
      account: "Account",
      ...
      password: "Password",
      passwordDescription: "Change the password for this FlickerX account.",
      passwordDialog: {
        ...
        setDescription:
          "Choose the password remote browsers sign in with as flickerx (at least {minLength} characters). The FlickerX Desktop App keeps signing in automatically.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Disabled by FLICKERX_HELPER_MODEL_DISABLE in the backend environment.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "Active via FLICKERX_MODEL_IDLE_TTL.",
      ...
      permissions: {
        ...
        bypassDescription:
          "How FlickerX approves chat tool calls (terminal, python, web, MCP) before they run. Full access disables approvals and the code sandbox.",
      },
      notifications: {
      ...
      startup: {
        ...
        launchAtLogin: "Run FlickerX at login",
        launchAtLoginDescription:
          "Start FlickerX in the background when you log in. It stays in the menu bar or system tray until you open it.",

        closeToTray: "Close to system tray",
        closeToTrayDescription:
          "Keep FlickerX and its server running in the background when you close the main window.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Clears local-only preferences and reloads FlickerX. Chats, API access, and DB-backed settings are kept.",
        confirmAction: "Reset and reload",
      },
    },
    profile: {
      title: "Profile",
      description: "How your profile appears in FlickerX.",
      changePicture: "Change profile picture",
      uploadPhoto: "Upload photo",
      removePhoto: "Remove",
      pictureOptions: "Profile picture options",
      displayName: "Display name",
      nickname: "What should FlickerX call you?",
      nicknamePlaceholder: "Nickname",
      nicknameSaved: "Preferred name saved",
      avatarShape: "Avatar shape",
      avatarShapeCircle: "Circle",
      avatarShapeRounded: "Rounded",
      greetingAvatar: "Avatar in greeting",
      greetingFlickerxDescription: "Show the avatar in the chat greeting.",
      ...
      stats: {
        title: "Your stats",
        subtitle:
          "Everything below is counted from your own history. Nothing is collected or sent to FlickerX.",
        retry: "Try again",
        privacyNote:
          "Stats are computed from the chat and training history held by your FlickerX install. Nothing is collected, and nothing is sent to FlickerX or any third party.",
        emptyChats:
    ...
    appearance: {
      title: "Appearance",
      description: "How FlickerX looks on this device.",
      theme: {
        title: "Theme",
        label: "Color scheme",
      ...
      palette: {
        label: "Color palette",
        description: "Colors used across FlickerX, in light and dark mode.",
        standard: "Standard",
        classic: "Classic",
        minimal: "Minimal",
      },
      custom: {
        ...
        uiFontSize: {
          label: "UI font size",
          description: "Adjust the base size used for the FlickerX UI.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "The language used by FlickerX.",
    ...
    resources: {
      title: "System",
      description: "Monitor this FlickerX server's hardware and storage.",
    ...
    agents: {
      title: "Agents",
      description:
        "Connect coding agents like Claude Code and Codex to a local model with flickerx start.",
      intro:
        "connects Claude Code, Codex, Hermes, OpenClaw, OpenCode and other agents to a model served locally by FlickerX, fully offline. It runs an OpenAI-compatible server and never touches your agent's config files.",
      ...
      modelNote:
        "Codex requires a GGUF model served by llama-server. Other agents can also use transformer-backed models; remove --model to use the model already loaded in FlickerX.",
      subagent: {
        title: "Use a local model as a subagent",
        description:
          "Keep {agent} on its current model and delegate selected tasks to this local FlickerX model.",
        ...
        opencodePrompt: "@flickerx find the cause of this test failure",
      },
      quickstart: {
      ...
      options: {
        ...
        description:
          "FlickerX flags are parsed first; anything it doesn't recognize is passed straight through to the agent.",
        model:
          "Select a model. Without --model, flickerx start uses the model currently loaded in Studio and errors if none is loaded.",
        contextLength:
        ...
        persist: "Keep FlickerX-managed agent storage between runs.",
        asSubagent:
          "Keep the parent on its current model and register FlickerX as a local subagent (Claude Code, Codex, and OpenCode).",
        apiKey: "Provide your FlickerX API key (or set FLICKERX_API_KEY).",
        yolo: "Skip approval prompts. Use only in trusted environments.",
      },
      remote: {
        title: "Connect to a remote Studio",
        description:
          "Point flickerx start at a Studio running elsewhere by setting these before launching (or pass --api-key directly):",
      },
      passthrough: {
        title: "Passing agent arguments",
        description:
          "Arguments after the FlickerX flags are forwarded to the agent itself, so native commands like resume still work:",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Access FlickerX via the OpenAI-compatible API.",
      ...
      secureHttpsHint:
        "The 0.0.0.0 port is still reachable globally. For full security, launch FlickerX with --secure to expose only this HTTPS link.",
    ...
    about: {
      ...
      shutDownStudio: "Shut down FlickerX",
      shutDownStudioDescription:
        "Stops the FlickerX server and ends your session.",
      shutDown: "Shut down",
      update: {
        title: "Update FlickerX",
        commandText: "{label} text",
        copied: "Copied",
        copyCommand: "Copy command",
        commandCopied: "{label} copied",
        copyNamedCommand: "Copy {label}",
        checkingInstall: "Checking how FlickerX was installed...",
        installIntro: "To install or update FlickerX:",
        ...
        restartAfterUpdate: "Restart FlickerX after updating.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Run `flickerx studio update` from the terminal that started your server.",
        ...
        desktopCurrentDescription:
          "FlickerX will continue checking automatically.",
        ...
        unknownInstall:
          "Could not detect how FlickerX was installed. For installer or PyPI installs, use the commands above.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "FlickerX couldn't confirm whether training started. Checking status in the background.",
    ...
    trainingStart: {
      ...
      terminalStart: "> flickerx training starts...",
