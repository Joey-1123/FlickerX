...
export const fr = {
  ...
  settings: {
    ...
    dialog: {
      title: "Paramètres",
      description: "Gérez vos préférences FlickerX.",
    ...
    debugging: {
      ...
      disabled: "La journalisation dans un fichier est désactivée (FLICKERX_STUDIO_NO_FILE_LOG=1).",
    ...
    voice: {
      ...
      dictation: {
        ...
        sttLoaded: "Chargé",
        sttUnavailable:
          "Non installé sur ce serveur. Exécutez `flickerx studio update` pour activer la dictée locale.",
        sttRetry: "Réessayer",
        ...
        micAccessBlocked:
          "L'accès au microphone a été bloqué. Autorisez l'accès au microphone pour cette page FlickerX, puis réessayez.",
    ...
    general: {
      title: "Général",
      description: "Préférences globales pour FlickerX.",
      account: "Compte",
      ...
      passwordDescription:
        "Changez le mot de passe de ce compte FlickerX.",
      passwordDialog: {
        ...
        setDescription:
          "Choisissez le mot de passe utilisé par les navigateurs distants pour se connecter avec l'identifiant flickerx (au moins {minLength} caractères). L'application de bureau FlickerX continue de se connecter automatiquement.",
      ...
      helperLlm: {
        ...
        disabledByEnv:
          "Désactivé par FLICKERX_HELPER_MODEL_DISABLE dans l'environnement du backend.",
      ...
      modelAutoSwitch: {
        ...
        idleActiveViaEnv: "Actif via FLICKERX_MODEL_IDLE_TTL.",
        loadError:
      ...
      startup: {
        ...
        launchAtLogin: "Lancer FlickerX à la connexion",
        launchAtLoginDescription:
          "Démarre FlickerX en arrière-plan lorsque vous vous connectez. Il reste dans la barre de menus ou la zone de notification jusqu'à ce que vous l'ouvriez.",

        closeToTray: "Fermer dans la zone de notification",
        closeToTrayDescription:
          "Laisser FlickerX et son serveur fonctionner en arrière-plan lorsque vous fermez la fenêtre principale.",
      ...
      resetPreferences: {
        ...
        confirmDescription:
          "Efface les préférences locales uniquement et recharge FlickerX. Les discussions, l'accès API et les paramètres stockés en base de données sont conservés.",
      ...
      permissions: {
        ...
        bypassDescription:
          "Comment FlickerX approuve les appels d'outils de la discussion (terminal, python, web, MCP) avant leur exécution. Le mode « Full access » désactive les demandes d'approbation et le bac à sable d'exécution du code.",
      },
    },
    profile: {
      title: "Profil",
      description: "Comment votre profil apparaît dans FlickerX.",
      changePicture: "Changer la photo de profil",
      displayName: "Nom affiché",
      nickname: "Comment FlickerX doit-il vous appeler ?",
      ...
      chooseAvatar: "Ou choisissez un avatar",
      ...
      greetingAvatar: "Paresseux dans le message d'accueil",
      greetingFlickerxDescription:
        "Afficher l'avatar dans le message d'accueil de la discussion..",
      noPicture: "Aucune photo de profil",
      noneLabel: "Aucun",
      stats: {
        title: "Vos statistiques",
        subtitle:
          "Tout ce qui suit est calculé à partir de votre propre historique. Rien n'est collecté ni envoyé à FlickerX.",
        retry: "Réessayer",
        privacyNote:
          "Les statistiques sont calculées à partir de l'historique des discussions et des entraînements conservé par votre installation FlickerX. Rien n'est collecté, et rien n'est envoyé à FlickerX ni à un tiers.",
        emptyChats:
    ...
    appearance: {
      title: "Apparence",
      description: "L'apparence d'FlickerX sur cet appareil.",
      theme: {
        title: "Thème",
      ...
      palette: {
        label: "Palette",
        description: "Couleurs utilisées dans FlickerX, en mode clair et sombre.",
        standard: "Standard",
        classic: "Classique",
        minimal: "Minimale",
      },
      custom: {
        ...
        uiFontSize: {
          ...
          description: "Ajustez la taille de base utilisée pour l'interface FlickerX.",
        },
        codeFontSize: {
      ...
      language: {
        ...
        description: "La langue utilisée par FlickerX.",
    ...
    resources: {
      title: "Système",
      description:
        "Surveillez le matériel et le stockage de ce serveur FlickerX.",
      ...
      llamaBackend: {
        ...
        envLocked: "Fixé à {backend} par la variable d'environnement FLICKERX_LLAMA_CPP_BACKEND, qui prévaut sur ce réglage.",
        backends: {
          auto: "Automatique",
          cpu: "CPU",
          cuda: "CUDA",
        ...
        unsupported: {
          ...
          localLink: "llama.cpp est un dossier local que vous avez lié vous-même ; FlickerX ne le remplacera pas.",
    ...
    agents: {
      title: "Agents",
      description:
        "Connectez des agents de codage comme Claude Code et Codex à un modèle local avec flickerx start.",
      intro:
        "connecte Claude Code, Codex, Hermes, OpenClaw, OpenCode et d'autres agents à un modèle servi localement par FlickerX, entièrement hors ligne. Il lance un serveur compatible OpenAI et ne touche jamais aux fichiers de configuration de votre agent.",
      ...
      modelNote:
        "Codex nécessite un modèle GGUF servi par llama-server. Les autres agents peuvent aussi utiliser des modèles basés sur transformers ; retirez --model pour utiliser le modèle déjà chargé dans FlickerX.",
      subagent: {
        title: "Utiliser un modèle local comme sous-agent",
        description:
          "Gardez {agent} sur son modèle actuel et déléguez certaines tâches à ce modèle FlickerX local.",
        ...
        opencodePrompt: "@flickerx trouve la cause de cet échec de test",
      },
      quickstart: {
      ...
      options: {
        ...
        description:
          "Les options FlickerX sont analysées en premier ; tout ce qu'FlickerX ne reconnaît pas est transmis tel quel à l'agent.",
        model:
          "Sélectionne un modèle. Sans --model, flickerx start utilise le modèle actuellement chargé dans Studio et échoue si aucun modèle n'est chargé.",
        contextLength:
        ...
        persist:
          "Conserve d'une exécution à l'autre les données d'agent gérées par FlickerX.",
        asSubagent:
          "Garde l'agent parent sur son modèle actuel et enregistre FlickerX comme sous-agent local (Claude Code, Codex et OpenCode).",
        apiKey:
          "Fournit votre clé API FlickerX, ou lit la variable FLICKERX_API_KEY.",
        yolo:
      ...
      remote: {
        ...
        description:
          "Faites pointer flickerx start vers un Studio exécuté ailleurs en définissant ces variables avant le lancement (ou passez --api-key directement) :",
      },
      passthrough: {
        title: "Transmettre des arguments à l'agent",
        description:
          "Les arguments placés après les options FlickerX sont transmis à l'agent lui-même, donc les commandes natives comme resume fonctionnent toujours :",
      },
      dryRun: {
    ...
    apiKeys: {
      title: "API",
      description: "Accédez à FlickerX via l'API compatible OpenAI.",
      ...
      secureHttpsHint:
        "Le service lié à l’adresse 0.0.0.0 reste accessible sur toutes les interfaces réseau. Pour une sécurité complète, lancez FlickerX avec --secure afin de n’exposer que ce lien HTTPS.",
    ...
    about: {
      ...
      studioVersion: "Version d'FlickerX",
      ...
      shutDownStudio: "Arrêter FlickerX",
      shutDownStudioDescription:
        "Arrête le serveur FlickerX et met fin à votre session.",
      shutDown: "Arrêter",
      update: {
        title: "Mettre à jour FlickerX",
        commandText: "Texte de la {label}",
        copied: "Copié",
        copyCommand: "Copier la commande",
        commandCopied: "{label} copiée",
        copyNamedCommand: "Copier la {label}",
        checkingInstall: "Vérification du mode d'installation d'FlickerX...",
        installIntro: "Pour installer ou mettre à jour FlickerX :",
        ...
        restartAfterUpdate: "Redémarrez FlickerX après la mise à jour.",
        desktopManaged:
        ...
        desktopExternalServer:
          "Exécutez `flickerx studio update` dans le terminal depuis lequel vous avez lancé le serveur.",
        ...
        desktopCurrentDescription:
          "FlickerX continuera à rechercher automatiquement les mises à jour.",
        ...
        unknownInstall:
          "Impossible de détecter le mode d'installation d'FlickerX. Pour les installations via installateur ou PyPI, utilisez les commandes ci-dessus.",
        localCheckout:
  ...
  studio: {
    ...
    training: {
      ...
      startUnconfirmed:
        "FlickerX n'a pas pu confirmer le démarrage de l'entraînement. Vérification de l'état en arrière-plan.",
    ...
    trainingStart: {
      ...
      terminalStart: "> l'entraînement flickerx démarre...",
