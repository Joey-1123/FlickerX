            ...
            <div className="flex flex-wrap gap-1">
              {entries.map((entry, index) => (
                <Badge
                  ...
                  className={
                    entry.source === "seed"
                      ? "corner-squircle h-4 border-blue-500/25 bg-blue-500/10 px-1.5 font-mono text-ui-10 text-blue-700 dark:text-blue-300"
                      : "corner-squircle h-4 px-1.5 font-mono text-ui-10"
                  }
                >
                  {entry.name}
                </Badge>
