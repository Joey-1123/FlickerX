    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-1.5">
        ...
        <p id={tokenHelpId} className="text-xs text-muted-foreground">
          {usingEnvToken
            ? "FlickerX detected a server env token, so saved/shared recipes can leave this blank."
            : "Blank is safest for saved/shared recipes because FlickerX will read the server environment at run time."}
        </p>
        {hasToken && (
      ...
      <p className="text-xs text-muted-foreground">
        Backed by FlickerX's built-in <code>github_repo</code> seed reader. Large
