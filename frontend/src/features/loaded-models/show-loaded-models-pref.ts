...
export const LOADED_MODELS_PREFERENCE_KEYS = {
  show: "flickerx_show_loaded_models_indicator",
  collapsed: "flickerx_loaded_models_collapsed",
  position: "flickerx_loaded_models_position",
  dismissed: "flickerx_loaded_models_dismissed",
} as const;
