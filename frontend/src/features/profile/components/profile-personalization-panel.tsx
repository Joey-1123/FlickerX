...
import { FLICKERX_AVATARS } from "../flickerx-avatars";
...
const PROFILE_STORAGE_KEY = "flickerx_user_profile";
const FLICKERX_NAME = /^large\s+/i;
...
export function ProfilePersonalizationPanel() {
  ...
  const previewName = draftName.trim() || sessionSub || "FlickerX";
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          ...
                          // icon's selection border linger when switching avatars.
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-3">
          ...
          >
            ...
            <Input
              ...
              autoComplete="off"
              placeholder={sessionSub || "FlickerX"}
