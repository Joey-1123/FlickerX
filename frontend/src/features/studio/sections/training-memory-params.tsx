        ...
        <ParamsRow
          ...
          tooltip={
            <>
              ...
              change aspect ratio.{" "}
              <a
                href="https://flickerx.ai/docs/basics/vision-fine-tuning"
                target="_blank"
      ...
      <ParamsRow
        ...
        tooltip={
          <>
            ...
            <a
              href="https://flickerx.ai/docs/get-started/fine-tuning-llms-guide/lora-hyperparameters-guide"
              target="_blank"
              rel="noopener noreferrer"
              className="text-primary underline"
            >
        ...
        >
          ...
          <SelectContent>
            ...
            {isMac ? (
              ...
              <SelectItem value="flickerx">FlickerX</SelectItem>
            )}
          </SelectContent>
        </Select>
      </ParamsRow>
