...
// Hub opened. A background timer would keep asking a server that usually has not changed, so
// re-read only on the moments this tab could have missed a switch.
