...
export type FlickerXSupportStatus = "supported" | "unsupported";

export interface FlickerXSupport {
  status: FlickerXSupportStatus;
  reason: string | null;
...
export function classifyFlickerXSupport({
  modelId,
  pipelineTag,
  tags,
  libraryName,
