...
const HF_TOKEN_KEY = "flickerx_hf_token";
const LEGACY_TRAINING_KEY = "flickerx_training_config_v1";
const HF_TOKEN_MIGRATION_KEY = "flickerx_hf_token_migration_v1";

const HF_TOKEN_SYNC_KEY = "flickerx_hf_token_backend_revision";
