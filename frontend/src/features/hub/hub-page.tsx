...
import { studioPageForTask } from "./lib/flickerx-support";
import { fingerprintToken } from "./lib/token-fingerprint";
import {
  buildDiscoverRows,
  detectResultFormat,
  isFlickerxFinetunable,
  matchesCapability,
  matchesFormat,
...
const MODELS_TAB_STORAGE_KEY = "flickerx.hub.modelsTab";
const ALL_MODELS_VIEW_STORAGE_KEY = "flickerx.hub.allModelsView";
const INVENTORY_SORT_STORAGE_KEY = "flickerx.hub.inventorySort";
const OWNER_SCOPE_STORAGE_KEY = "flickerx.hub.ownerScope";
...
const DEFAULT_DISCOVER_CHANNEL: ChannelId = "flickerx-trending";
const FEED_LIST_CHANNEL_ID: ChannelId = "flickerx-latest";
  ...
  const filteredDiscoverRows = useMemo(() => {
    ...
    return discoverRows.filter(
      (row) =>
        ...
        (!activeChannel?.finetunableOnly || isFlickerxFinetunable(row.result)) &&
