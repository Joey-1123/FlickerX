...
export const AUTH_TOKEN_KEY = "flickerx_auth_token";
export const AUTH_REFRESH_TOKEN_KEY = "flickerx_auth_refresh_token";
export const AUTH_MUST_CHANGE_PASSWORD_KEY = "flickerx_auth_must_change_password";
