          ...
          <div className="pointer-events-auto col-start-2 justify-self-end pr-3 pt-[var(--studio-chat-header-padding-top,11px)] @[50rem]:justify-self-center @[50rem]:pr-0">
            <PillTabs
              ...
              onValueChange={(v) => {
                if (v !== "train") return;
                toast.info(
                  "Audio fine-tuning lives on the Train page. FlickerX trains TTS and STT models there. Pick an audio model and appropriate dataset.",
                  { duration: 8000 },
                );
