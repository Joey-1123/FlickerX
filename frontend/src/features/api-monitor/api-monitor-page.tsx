...
// Full-page monitor for FlickerX's OpenAI-compatible API server. Settings still owns
      ...
      <header className="flex flex-wrap items-start justify-between gap-4">
        <div className="flex min-w-0 flex-col gap-1">
          ...
          <p className="text-sm text-muted-foreground">
            Live traffic through FlickerX&apos;s OpenAI-compatible server.
          </p>
        </div>
            ...
            {loading ? (
              ...
              <p className="px-4 py-10 text-center text-sm text-muted-foreground">
                {entries.length > 0
                  ...
                  : loggingDisabled
                    ? "Recording is off: UNFLICKERX_STUDIO_DISABLE_API_MONITOR is set. Requests and model loads still run normally, they are just not listed here. Unset the variable and restart Studio to re-enable."
