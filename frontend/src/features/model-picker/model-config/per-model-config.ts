...
const STORAGE_KEY = "flickerx_model_configs";
const LEGACY_STORAGE_KEY = "flickerx_load_settings";
const LEGACY_MIGRATION_FLAG = "flickerx_model_configs_migrated";
...
export const ADVANCED_SETTINGS_OPEN_KEY = "flickerx_model_advanced_settings";
