...
interface ModelSelectorProps {
  ...
  /** Also list community models for `task`. Opt-in: only pages
  ...
  return (
    <PopoverTrigger asChild={true}>
      <button
        ...
        data-tour={dataTour}
        className={cn(
          "flickerx-model-selector-trigger group/trigger flex min-w-0 items-center gap-2 transition-colors",
...
const HUB_SECTION_KEY = "flickerx_model_selector_section";
...
function ModelSelectorContent({
  ...
  return (
    <PopoverContent
      ...
      className={cn(
        "flickerx-model-selector-menu menu-soft-surface ring-0 max-w-[calc(100vw-1rem)] min-w-0 gap-0",
        visibleConfigTarget
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <ModelSelectorContent
        ...
        // A community-enabled one (Audio) already lists past flickerx, so it keeps it.
        onBrowseHub={
