    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild={true}>
        <button
          ...
          className="flickerx-model-selector-trigger flex h-[34px] min-w-0 max-w-[320px] items-center gap-2 rounded-full pl-4 pr-2 text-sm transition-colors hover:bg-accent"
        >
