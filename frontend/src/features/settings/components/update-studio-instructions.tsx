...
const STUDIO_INSTALL_UNIX_CMD =
  "curl -fsSL https://flickerx.ai/install.sh | sh";
const STUDIO_INSTALL_WINDOWS_CMD = "irm https://flickerx.ai/install.ps1 | iex";
...
const DOCS_INSTALL_URL = "https://flickerx.ai/docs/get-started/install";
const DOCS_UPDATING_URL =
  "https://flickerx.ai/docs/get-started/install/updating";
const DOCS_MAC_URL = "https://flickerx.ai/docs/get-started/install/mac";
const DOCS_WINDOWS_URL =
  "https://flickerx.ai/docs/get-started/install/windows-installation";
