...
function RemotePasswordRow({
  ...
  return (
    <SettingsRow
      ...
      description="Remote browsers sign in as flickerx. The FlickerX Desktop App keeps signing in automatically."
    >
    ...
    >
        ...
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="flex min-w-0 flex-col gap-0.5">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Use FlickerX and its APIs from other devices through a secure,
      ...
      <div className="border-t border-border/60 px-4 py-1">
        ...
        <SettingsRow
          ...
          description="Create a new remote URL each time FlickerX starts. Stopping remote access now won’t turn this off."
        >
          <Switch
