...
const VRAM_BUDGET_EVENT = "flickerx-vram-budget-change";
const VRAM_BUDGET_LOCK_EVENT = "flickerx-vram-budget-lock";

export type VramBudgetSettings = {
  /** Fraction of each GPU a load may claim, e.g. 0.97. */
  fraction: number;
  /** False when inherited from UNFLICKERX_VRAM_FRACTION or the built-in default. */
  isStored: boolean;
