...
// would log the user out (flickerx_auth_token, flickerx_auth_refresh_token, and
// flickerx_auth_must_change_password are excluded).
const PREFS_KEYS: string[] = [
  // Appearance
  "theme",
  "palette",
  "flickerx_appearance_customization",
  LOCALE_STORAGE_KEY,
  // UI state
  "sidebar_pinned",
  "sidebar_width",
  "chat_settings_width",
  "flickerx_sidebar_navigate_open",
  // Grouping, sort and the manual row order.
  SIDEBAR_ORGANIZATION_STORAGE_KEY,
  "flickerx_settings_active_tab",
  SETTINGS_PANEL_PREFS_STORAGE_KEY,
  // Chat runtime prefs
  "flickerx_chat_auto_title",
  "flickerx_chat_permission_mode",
  // Legacy confirm key: loadPermissionMode falls back to it, so clear both or a reset restores it.
  "flickerx_chat_confirm_tool_calls",
  "flickerx_hf_token",
  "flickerx_auto_heal_tool_calls",
  "flickerx_nudge_tool_calls",
  "flickerx_max_tool_calls_per_message",
  "flickerx_tool_call_timeout",
  "flickerx_chat_inference_params",
  "flickerx_chat_collapsible_state",
  "flickerx_chat_preferences",
  "flickerx_model_configs",
  "flickerx_model_configs_migrated",
  "flickerx_load_settings",
  "flickerx_model_advanced_settings",
  "flickerx_chat_load_on_selection",
  ...
  // Chat presets
  "flickerx_chat_custom_presets",
  "flickerx_chat_active_preset",
  "flickerx_chat_system_prompts",
  "flickerx_chat_system_prompts_migrated",
  // Training UI prefs
  "flickerx_training_config_v1",
  "flickerx_prev_max_steps",
  "flickerx_prev_save_steps",
  ...TRAINING_UI_PREFERENCE_KEYS,
  // Profile personalization
  "flickerx_user_profile",
  // Guided tour flags
  "tour:studio:v1",
  // Update notifications
  "flickerx_show_llama_update_banner",
  "flickerx_monitor_overlay",
