...
export function ChatTab() {
  ...
  const setShowGreetingAvatar = useUserProfileStore(
    (s) => s.setShowGreetingAvatar,
  );
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <SettingsSection title={t("settings.general.chatDefaults")}>
        ...
        <SettingsRow
          label={t("settings.profile.greetingAvatar")}
          description={t("settings.profile.greetingFlickerxDescription")}
        >
          <Switch
            id="profile-greeting-avatar"
            checked={showGreetingAvatar}
            onCheckedChange={setShowGreetingAvatar}
          />
        </SettingsRow>
      </SettingsSection>
