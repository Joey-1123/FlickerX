...
const AUTO_TITLE_KEY = "flickerx_chat_auto_title";
const AUTO_HEAL_TOOL_CALLS_KEY = "flickerx_auto_heal_tool_calls";
const NUDGE_TOOL_CALLS_KEY = "flickerx_nudge_tool_calls";
const MAX_TOOL_CALLS_KEY = "flickerx_max_tool_calls_per_message";
const TOOL_CALL_TIMEOUT_KEY = "flickerx_tool_call_timeout";
const INFERENCE_PARAMS_KEY = "flickerx_chat_inference_params";
const CHAT_ACTIVE_PRESET_KEY = "flickerx_chat_active_preset";
const CHAT_ACTIVE_PRESET_SOURCE_KEY = "flickerx_chat_active_preset_source";
const REASONING_EFFORT_KEY = "flickerx_reasoning_effort";
const PRESERVE_THINKING_KEY = "flickerx_preserve_thinking";
const COLLAPSE_HTML_ARTIFACTS_KEY = "flickerx_chat_collapse_html_artifacts";
const ALLOW_ARTIFACT_NETWORK_ACCESS_KEY =
  "flickerx_chat_allow_artifact_network_access";
const CHAT_PRESETS_KEY = "flickerx_chat_custom_presets";
const LEGACY_CHAT_SYSTEM_PROMPTS_KEY = "flickerx_chat_system_prompts";
const LEGACY_CHAT_SETTINGS_IMPORT_KEY =
  "flickerx_chat_settings_imported_to_studio_db";
