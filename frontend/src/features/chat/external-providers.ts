...
const REGISTRY_MODEL_CAPABILITIES_KEY =
  "flickerx_chat_provider_model_capabilities";
...
const EXTERNAL_PROVIDERS_KEY = "flickerx_chat_external_providers";
const EXTERNAL_PROVIDER_KEYS_KEY = "flickerx_chat_external_provider_keys";
const CONNECTIONS_ENABLED_KEY = "flickerx_chat_connections_enabled";
