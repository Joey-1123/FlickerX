...
export const CHAT_REASONING_ENABLED_KEY = "flickerx_chat_reasoning_enabled";
export const CHAT_TOOLS_ENABLED_KEY = "flickerx_chat_tools_enabled";
export const CHAT_CODE_TOOLS_ENABLED_KEY = "flickerx_chat_code_tools_enabled";
export const CHAT_IMAGE_TOOLS_ENABLED_KEY = "flickerx_chat_image_tools_enabled";
export const CHAT_DEEP_RESEARCH_ENABLED_KEY =
  "flickerx_chat_deep_research_enabled";
export const CHAT_DEEP_RESEARCH_WEBSITE_POLICY_KEY =
  "flickerx_chat_deep_research_website_policy";
export const CHAT_ARTIFACTS_ENABLED_KEY = "flickerx_chat_artifacts_enabled";
export const CHAT_SHOW_CANVAS_MENU_ITEM_KEY =
  "flickerx_chat_show_canvas_menu_item";
export const CHAT_COLLAPSE_HTML_ARTIFACTS_KEY =
  "flickerx_chat_collapse_html_artifacts";
export const CHAT_ALLOW_ARTIFACT_NETWORK_ACCESS_KEY =
  "flickerx_chat_allow_artifact_network_access";
export const CHAT_MCP_ENABLED_KEY = "flickerx_chat_mcp_enabled";
export const CHAT_CONFIRM_TOOL_CALLS_KEY = "flickerx_chat_confirm_tool_calls";
export const CHAT_EXPAND_QUANTIZATIONS_KEY =
  "flickerx_chat_expand_quantizations";
export const CHAT_SHOW_ALL_QUANTIZATIONS_KEY =
  "flickerx_chat_show_all_quantizations";
export const MODELS_FIT_ON_DEVICE_ONLY_KEY =
  "flickerx_models_fit_on_device_only";
export const CHAT_BYPASS_PERMISSIONS_KEY = "flickerx_chat_bypass_permissions";
export const CHAT_PERMISSION_MODE_KEY = "flickerx_chat_permission_mode";
...
export const CHAT_WEB_FETCH_TOOLS_ENABLED_KEY =
  "flickerx_chat_web_fetch_tools_enabled";
export const CHAT_RAG_SOURCE_KEY = "flickerx_chat_rag_source";
export const CHAT_RAG_MODE_KEY = "flickerx_chat_rag_mode";
export const CHAT_RAG_TOP_K_KEY = "flickerx_chat_rag_top_k";
export const CHAT_RAG_AUTOINJECT_KEY = "flickerx_chat_rag_autoinject";
export const CHAT_RAG_AUTOINJECT_MIN_SCORE_KEY =
  "flickerx_chat_rag_autoinject_min_score";
export const CHAT_RAG_OCR_KEY = "flickerx_chat_rag_ocr_scanned";
export const CHAT_RAG_CAPTION_KEY = "flickerx_chat_rag_caption_figures";
export const CHAT_SPECULATIVE_TYPE_KEY = "flickerx_chat_speculative_type";
export const CHAT_GPU_MEMORY_MODE_KEY = "flickerx_chat_gpu_memory_mode";
...
const LAST_EXTERNAL_CHECKPOINT_KEY = "flickerx_chat_last_external_checkpoint";
...
const THREAD_SETTINGS_REPLAY_KEY = "flickerx_chat_thread_settings_replay";
  ...
  const manualKnobs =
    mode === "manual"
      ...
      : {
          ...
          // flickerx_zoo upgrade that adds --ngl.
          ...(resp.is_diffusion
            ? droppedSplit != null
...
type ChatRuntimeStore = {
  ...
  /**
   * When on, local FlickerX tool calls pause for an explicit allow/deny in the
  ...
  /** GPU memory strategy for GGUF loads. "auto" = FlickerX picks GPUs and context
...
// Mirror token edits made through the shared store (e.g. FlickerX's field).
