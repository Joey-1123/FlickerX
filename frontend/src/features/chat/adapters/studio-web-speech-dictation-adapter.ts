...
export const describeMediaError = (error: unknown): string => {
  ...
  if (name === "NotAllowedError" || name === "SecurityError") {
    return "Microphone access is blocked. Allow microphone access for this FlickerX page, then try again.";
  }
...
export const describeSpeechError = (
  ...
  if (error === "not-allowed") {
    return "Speech recognition was blocked by the browser. Check microphone permissions for this FlickerX page.";
  }
