...
// FlickerX reads this as a ChatML dataset.
...
async function buildThreadContent(
  ...
  if (format === "jsonl-raw") {
    // OpenAI/ChatML: FlickerX reads the "messages" key as ChatML.
    const oaiMsgs: OAIMessage[] = messages.flatMap((msg) => messageToOpenAI(msg));
...
// string-only content in system/user/assistant turns. FlickerX's training tab
              ...
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    ShareGPT format for FlickerX fine-tuning
                  </p>
