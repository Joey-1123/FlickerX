...
const COLLAPSIBLE_STATE_KEY = "flickerx_chat_collapsible_state";
  ...
  return (
    <div className="flex items-center justify-between gap-3">
      <div className="flex min-w-0 items-center gap-1.5">
        ...
        <InfoHint>
          FlickerX auto-fixes broken tool calls so inference output is never
          broken.
        </InfoHint>
      </div>
      <Switch
    ...
    <div className="flex items-center justify-between gap-3">
      <div className="flex min-w-0 flex-col gap-0.5">
        <div className="flex min-w-0 items-center gap-1.5">
          ...
          <InfoHint>
            When on, every local FlickerX tool call pauses for your approval
  ...
  return (
    <div className="flex flex-col gap-2">
      <div className="flex min-w-0 items-center gap-1.5">
        ...
        <InfoHint>
          Choose how FlickerX approves tool calls before they run. Full access
