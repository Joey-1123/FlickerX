...
/**
 * A relative link in a release body means "somewhere in the FlickerX
...
const LINK_BASE = "https://github.com/FlickerX/FlickerX/blob/main/";
const IMAGE_BASE = "https://raw.githubusercontent.com/FlickerX/FlickerX/main/";
