...
* FlickerX / bitsandbytes, to check it fits the GPU before training.
*
* Formula: totalParams * 0.90 + 1.4 GB
*
* Calibrated against isolated FlickerX loads on RTX 5070 Ti (2026.2):
...
/**
* Estimate VRAM (GB) to load a model with FlickerX. Bytes/param: QLoRA 4-bit bnb -> 0.90
