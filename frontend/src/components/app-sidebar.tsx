...
const EMPHASIS_MARKER = "__UNFLICKERX_I18N_EMPHASIS_MARKER__";
...
export function AppSidebar() {
  ...
  const trainDisabledHint: string | undefined = !chatOnlyMeasured
    ...
    : chatOnlyReason === "mlx_unavailable"
      ? // The gate is all-or-nothing across mlx, mlx-lm and mlx-vlm, and a resolver
        ...
        // actionable to someone whose `flickerx update` has already run.
        chatOnlyDetail
        ? `Training needs MLX: ${chatOnlyDetail}. Run \`flickerx update\` to enable Train.`
        : "Training needs MLX. Run `flickerx update` to enable Train."
    ...
    return (
      <DropdownMenu>
        ...
        <DropdownMenuContent
          ...
          align="end"
          sideOffset={2}
          className="flickerx-plus-menu w-56"
        >
  ...
  function renderProjectContextMenu() {
    ...
    return (
      <ContextMenuContent className="flickerx-plus-menu menu-flat-destructive w-52">
          ...
          >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                ...
                align="start"
                sideOffset={0}
                className="flickerx-plus-menu menu-flat-destructive w-56"
              >
                ...
                <DropdownMenuSub>
                  ...
                  <DropdownMenuSubContent
                    sideOffset={0}
                    alignOffset={-4}
                    className="flickerx-plus-menu w-52"
                  >
                    <DropdownMenuItem
                      onSelect={() => {
                ...
                <DropdownMenuSub>
                  ...
                  <DropdownMenuSubContent sideOffset={8} alignOffset={-4} className="flickerx-plus-menu w-52">
              ...
              <DropdownMenuTrigger asChild>
                ...
                >
                  ...
                  <div className="flex min-w-0 flex-1 flex-col gap-px leading-tight group-data-[collapsible=icon]:hidden">
                    ...
                    <span className="truncate text-ui-11p5 tracking-nav text-muted-foreground">FlickerX</span>
                  </div>
                </SidebarMenuButton>
              </DropdownMenuTrigger>
              <DropdownMenuContent
