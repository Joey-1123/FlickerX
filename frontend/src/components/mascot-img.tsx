...
import fallbackMascot from "@/assets/mascot-fallback.svg?inline";

const LEADING_SLASH = /^\//;

// Resolve a public-folder asset against the deploy base (subpath mounts) and
// encode the spaced avatar filenames.
...
// whenever the source changes (greeting avatars rotate).
...
// fallback avatar. Empty alt by default so a broken image never paints text.
